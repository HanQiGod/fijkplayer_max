...
### 创建播放器
[dart api FijkPlayer](https://pub.dev/documentation/fijkplayer_max/latest/fijkplayer_max/FijkPlayer/FijkPlayer.html) 
```dart
...
### 销毁
[dart api release](https://pub.dev/documentation/fijkplayer_max/latest/fijkplayer_max/FijkPlayer/release.html) 
```dart
...
* 设置资源
[dart api setDataSource](https://pub.dev/documentation/fijkplayer_max/latest/fijkplayer_max/FijkPlayer/setDataSource.html) 
```dart
...
* 异步加载  
[dart api prepareAsync](https://pub.dev/documentation/fijkplayer_max/latest/fijkplayer_max/FijkPlayer/prepareAsync.html) 
```dart
...
* 开始  
[dart api start](https://pub.dev/documentation/fijkplayer_max/latest/fijkplayer_max/FijkPlayer/start.html)
```dart
...
* 暂停  
[dart api pause](https://pub.dev/documentation/fijkplayer_max/latest/fijkplayer_max/FijkPlayer/pause.html)
```dart
...
* 停止  
[dart api stop](https://pub.dev/documentation/fijkplayer_max/latest/fijkplayer_max/FijkPlayer/stop.html)
```dart
...
* 重置  
[dart api reset](https://pub.dev/documentation/fijkplayer_max/latest/fijkplayer_max/FijkPlayer/reset.html)
```dart
...
* 进度跳转  
[dart api seekTo](https://pub.dev/documentation/fijkplayer_max/latest/fijkplayer_max/FijkPlayer/seekTo.html)
```dart
...
* 调节音量 [dart api](https://pub.dev/documentation/fijkplayer_max/latest/fijkplayer_max/FijkPlayer/setVolume.html)
```dart
...
* 设置播放循环 [dart api](https://pub.dev/documentation/fijkplayer_max/latest/fijkplayer_max/FijkPlayer/setLoop.html)
```dart
...
* 设置播放倍速 [dart api](https://pub.dev/documentation/fijkplayer_max/latest/fijkplayer_max/FijkPlayer/setSpeed.html)
```dart
...
[FijkValue](https://pub.dev/documentation/fijkplayer_max/latest/fijkplayer_max/FijkValue-class.html) 中包含了所有的第一类（会发生变化但是变化不频繁）播放器信息。  
...
相关的方法后续也会补充在这里，或者查看 [dart api 文档页面](https://pub.dev/documentation/fijkplayer_max/latest/fijkplayer_max/fijkplayer_max-library.html)
